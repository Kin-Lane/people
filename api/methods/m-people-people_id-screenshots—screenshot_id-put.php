...
$app->put($route, function ($people_id,$screenshot_id)  use ($app){
	...
	if(isset($param['path']))
		...
		$query = "UPDATE profile_screenshot SET Type = '" . $type . "', Image_URL = '" . $path . "', Image_Name = '" . $name . "' WHERE Profile_ID = " . $screenshot_id;
